...
export default function ConnectionTuningNew() {
  ...
  const renderConnectionSection = (type: 'PRIMARY' | 'SECONDARY') => {
    ...
    return (
      <div className="space-y-2 border border-gray-200 dark:border-gray-700 rounded p-2">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="flex gap-1">
              <input
                ...
                className="w-12 px-1 py-0.5 text-[10px] rounded bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-400"
                placeholder="Value"
              />
              <select
                value={(config[ingressKey] as BandwidthValue).unit}
                onChange={(e) => handleUnitChange(ingressKey, e.target.value)}
                className="w-12 px-0.5 py-0.5 text-[10px] rounded bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-400"
              >
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 shadow-sm transition-colors duration-200 h-card">
      <div className="p-3">
        <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-3">Connection Settings</h2>
