...
scp -P 12222 root@192.168.1.1:/usr/local/darkflows/installer_packages/darkflows_scripts.tgz .
scp -P 12222 root@192.168.1.1:/usr/local/darkflows/installer_packages/darkflows_configs.tgz .
