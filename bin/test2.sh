...
update_qos_settings() {
    ...
    tc class add dev ifb0 parent 1: classid 1:1 htb rate $INGRESS_BANDWIDTH
    ...
    tc class add dev $PRIMARY_INTERFACE parent 1: classid 1:1 htb rate $EGRESS_BANDWIDTH
