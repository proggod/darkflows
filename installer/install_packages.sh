...
apt install -y python3-pexpect openssh-server mariadb-server nodejs npm nftables kea curl screen vlan irqbalance lightdm firefox-esr ethtool samba iperf3 ca-certificates iftop
